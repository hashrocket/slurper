...
== Setup
  ...
  $sudo gem install slurper

You must install with sudo currently.
...
Create a stories.txt file and compose your stories in the slurper story format. In your working directory use the slurp command to import your stories from the stories.txt file into Pivotal Tracker.
